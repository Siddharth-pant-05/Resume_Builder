    ...
    return (
        <div>
            ...
            <div className='flex items-center gap-2'>
                <label>
                    {props.data.image ? (
                        <img src={typeof props.data.image === 'string' ? props.data.image : URL.createObjectURL(props.data.image)} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80' />
                    ) : (
                ...
                {typeof props.data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        <p>Remove Background</p>
                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                            <input type="checkbox" className='sr-only peer' onChange={() => { props.setRemoveBackground(prev => !prev) }} checked={props.removeBackground} />
